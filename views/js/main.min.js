...
var pizzaIngredients={},scrollTopPosition=0,scrollLeftPosition=0,body=document.body;pizzaIngredients.meats="Pepperoni;Sausage;Fennel Sausage;Spicy Sausage;Chicken;BBQ Chicken;Chorizo;Chicken Andouille;Salami;Tofu;Bacon;Canadian Bacon;Proscuitto;Italian Sausage;Ground Beef;Anchovies;Turkey;Ham;Venison;Lamb;Duck;Soylent Green;Carne Asada;Soppressata Picante;Coppa;Pancetta;Bresola;Lox;Guanciale;Chili;Beef Jerky;Pastrami;Kielbasa;Scallops;Filet Mignon".split(";");pizzaIngredients.nonMeats="White Onions;Red Onions;Sauteed Onions;Green Peppers;Red Peppers;Banana Peppers;Ghost Peppers;Habanero Peppers;Jalapeno Peppers;Stuffed Peppers;Spinach;Tomatoes;Pineapple;Pear Slices;Apple Slices;Mushrooms;Arugula;Basil;Fennel;Rosemary;Cilantro;Avocado;Guacamole;Salsa;Swiss Chard;Kale;Sun Dried Tomatoes;Walnuts;Artichoke;Asparagus;Caramelized Onions;Mango;Garlic;Olives;Cauliflower;Polenta;Fried Egg;Zucchini;Hummus".split(";");
...
pizzaIngredients.sauces=["Red Sauce","Marinara","BBQ Sauce","No Sauce","Hot Sauce"];pizzaIngredients.crusts=["White Crust","Whole Wheat Crust","Flatbread Crust","Stuffed Crust"];String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};
...
case "praise":return"beautiful intelligent smart genius ingenious gorgeous pretty witty angelic handsome graceful talented exquisite enchanting fascinating interesting divine alluring ravishing wonderful magnificient marvelous dazzling cute charming attractive nifty delightful superior amiable gentle heroic courageous valiant brave noble daring fearless gallant adventurous cool enthusiastic fierce awesome radical tubular fearsome majestic grand stunning".split(" ");case "scientific":return a="scientific technical digital programming calculating formulating cyberpunk mechanical technological innovative brainy chemical quantum astro space theoretical atomic electronic gaseous investigative solar extinct galactic".split(" ");
default:return a="scientific technical digital programming calculating formulating cyberpunk mechanical technological innovative brainy chemical quantum astro space theoretical atomic electronic gaseous investigative solar extinct galactic".split(" ")}}
...
case "scifi":return a="robot alien raygun spaceship UFO rocket phaser astronaut spaceman planet star galaxy computer future timeMachine wormHole timeTraveler scientist invention martian pluto jupiter saturn mars quasar blackHole warpDrive laser orbit gears molecule electron neutrino proton experiment photon apparatus universe gravity darkMatter constellation circuit asteroid".split(" ");default:return a="robot alien raygun spaceship UFO rocket phaser astronaut spaceman planet star galaxy computer future timeMachine wormHole timeTraveler scientist invention martian pluto jupiter saturn mars quasar blackHole warpDrive laser orbit gears molecule electron neutrino proton experiment photon apparatus universe gravity darkMatter constellation circuit asteroid".split(" ")}}
var adjectives="dark color whimsical shiny noise apocalyptic insulting praise scientific".split(" "),nouns="animals everyday fantasy gross horror jewelry places scifi".split(" ");function generator(a,b){var c=getAdj(a),e=getNoun(b),d=parseInt(Math.random()*c.length),f=parseInt(Math.random()*e.length);return"The "+c[d].capitalize()+" "+e[f].capitalize()}
...
function(){return pizzaIngredients.crusts[Math.floor(Math.random()*pizzaIngredients.crusts.length)]},ingredientItemizer=function(a){return"<li>"+a+"</li>"},makeRandomPizza=function(){for(var a="",b=Math.floor(4*Math.random()),c=Math.floor(3*Math.random()),e=Math.floor(2*Math.random()),d=0;d<b;d++)a+=ingredientItemizer(selectRandomMeat());for(d=0;d<c;d++)a+=ingredientItemizer(selectRandomNonMeat());for(d=0;d<e;d++)a+=ingredientItemizer(selectRandomCheese());a+=ingredientItemizer(selectRandomSauce());
return a+=ingredientItemizer(selectRandomCrust())},pizzaElementGenerator=function(a){var b,c,e,d;b=document.createElement("div");c=document.createElement("div");e=document.createElement("img");d=document.createElement("div");b.classList.add("randomPizzaContainer");b.style.width="33.33%";b.style.height="325px";b.id="pizza"+a;c.classList.add("col-md-6");e.src="images/pizza.png";e.classList.add("img-responsive");c.appendChild(e);b.appendChild(c);d.classList.add("col-md-6");a=document.createElement("h4");
a.innerHTML=randomName();d.appendChild(a);a=document.createElement("ul");a.innerHTML=makeRandomPizza();d.appendChild(a);b.appendChild(d);return b},resizePizzas=function(a){window.performance.mark("mark_start_resize");a:switch(a){case "1":document.querySelector("#pizzaSize").innerHTML="Small";break a;case "2":document.querySelector("#pizzaSize").innerHTML="Medium";break a;case "3":document.querySelector("#pizzaSize").innerHTML="Large";break a;default:/*console.log("bug in changeSliderLabel")*/}for(var b=
0;b<document.querySelectorAll(".randomPizzaContainer").length;b++){var c,e=document.querySelectorAll(".randomPizzaContainer")[b];c=a;var d=e.offsetWidth,e=document.querySelector("#randomPizzas").offsetWidth,d=d/e,f=void 0;a:{switch(c){case "1":f=.25;break a;case "2":f=.3333;break a;case "3":f=.5;break a;default:/*console.log("bug in sizeSwitcher")*/}f=void 0}c=(f-d)*e;c=document.querySelectorAll(".randomPizzaContainer")[b].offsetWidth+c+"px";document.querySelectorAll(".randomPizzaContainer")[b].style.width=
c}window.performance.mark("mark_end_resize");window.performance.measure("measure_pizza_resize","mark_start_resize","mark_end_resize");a=window.performance.getEntriesByName("measure_pizza_resize");/*console.log("Time to resize pizzas: "+a[0].duration+"ms")*/};window.performance.mark("mark_start_generating");for(var i=2;100>i;i++){var pizzasDiv=document.getElementById("randomPizzas");pizzasDiv.appendChild(pizzaElementGenerator(i))}window.performance.mark("mark_end_generating");
window.performance.measure("measure_pizza_generation","mark_start_generating","mark_end_generating");var timeToGenerate=window.performance.getEntriesByName("measure_pizza_generation");/*console.log("Time to generate pizzas on load: "+timeToGenerate[0].duration+"ms")*/;var frame=0;function logAverageFrame(a){for(var b=a.length,c=0,e=b-1;e>b-11;e--)c+=a[e].duration;/*console.log("Average time to generate last 10 frames: "+c/10+"ms")*/}
function updatePositions1(){frame++;window.performance.mark("mark_start_frame");for(var a=document.querySelectorAll(".mover"),b=0;b<a.length;b++){var c=Math.sin(scrollTopPosition/1250+b%5);a[b].style.left=a[b].basicLeft+100*c+"px"}window.performance.mark("mark_end_frame");window.performance.measure("measure_frame_duration","mark_start_frame","mark_end_frame");0===frame%10&&(a=window.performance.getEntriesByName("measure_frame_duration"),logAverageFrame(a))}window.addEventListener("scroll",updatePositions2);
function updatePositions2(){scrollTopPosition=body.scrollTop;scrollLeftPosition=body.scrollLeft;frame++;window.performance.mark("mark_start_frame");window.performance.mark("mark_end_frame");window.performance.measure("measure_frame_duration","mark_start_frame","mark_end_frame");if(0===frame%10){var a=window.performance.getEntriesByName("measure_frame_duration");logAverageFrame(a)}}window.setInterval(updatePositions1,25);window.setInterval(resizePizzas,25);
document.addEventListener("DOMContentLoaded",function(){for(var a=0;200>a;a++){var b=document.createElement("img");b.className="mover";b.src="images/pizza.png";b.style.height="100px";b.style.width="73.333px";b.basicLeft=a%8*256;b.style.top=256*Math.floor(a/8)+"px";document.querySelector("#movingPizzas1").appendChild(b)}updatePositions1()});
